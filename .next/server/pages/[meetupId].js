...
async function getStaticPaths() {
    const client = await external_mongodb_.MongoClient.connect("mongodb+srv://super-admin:dkJLioWPLIByTxyz@cluster0.ihitd.mongodb.net/meetups?retryWrites=true&w=majority");
    const db = client.db();
