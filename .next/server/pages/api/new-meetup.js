...
async function handler(req, res) {
    if (req.method === "POST") {
        const data = req.body;
        const client = await external_mongodb_namespaceObject.MongoClient.connect("mongodb+srv://super-admin:dkJLioWPLIByTxyz@cluster0.ihitd.mongodb.net/meetups?retryWrites=true&w=majority");
        const db = client.db();
